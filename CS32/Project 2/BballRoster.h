...
{
public:
    // default constructor - create an empty BballRoster list
    BballRoster() : head(nullptr), tail(nullptr) { }
...
private:
    ...
    //Head node pointer for doubly-linked list
    Node* head;
    Node* tail;
    ...
    void insertPlayerToFront(const std::string& firstName, const std::string&
                       lastName, const SomeType& value);
    
    void insertPlayerToRear(const std::string& firstName, const std::string&
                      lastName, const SomeType& value);
